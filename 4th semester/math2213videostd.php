...
<body>
	...
	<div class="part">
   	    <ul>
			...
			<i class="fa fa-circle-o" aria-hidden="true" style="font-size:15px;color:#3A6E96;"></i>
			<i class="fa fa-circle-o" aria-hidden="true" style="font-size:15px;color:#3A6E96;"></i></div>
   	    	<div class="bb"><li class="active"><a href="math2213videostd.php"><i class="fa fa-laptop" aria-hidden="true" style="font-size:35px;"></i></a><br />Video/Slide</li></div>
			<div class="b"><i class="fa fa-circle-o" aria-hidden="true" style="font-size:15px;color:#3A6E96;"></i>
			<i class="fa fa-circle-o" aria-hidden="true" style="font-size:15px;color:#3A6E96;"></i>
			<i class="fa fa-circle-o" aria-hidden="true" style="font-size:15px;color:#3A6E96;"></i></div>
   	    	<div class="bb"><li ><a href="math2213questionstd.php"><i class="fa fa-question aria-hidden="true" style="font-size:38px;"></i></a><br />Question</li></div>
    ...
    <div class="uk-offcanvas-bar">
        <ul class="uk-nav uk-nav-offcanvas" data-uk-nav><center><div class="head"><h2>CSE 3101</h2></div></center></ul>
			<div class="open">
				...
				<div class="course">
					 <a href="cse2201videostd.php"><?php echo("CSE 2201 & CSE 2202") ;  ?></a>
           <hr /><a href="cse2203videostd.php"><?php echo("CSE 2203 & CSE 2204") ;  ?></a>
           <hr /><a href="cse2205videostd.php"><?php echo("CSE 2205 & CSE 2206") ;  ?></a>
           <hr /><a href="math2213videostd.php"><?php echo("MATH 2213") ;  ?></a>
           <hr /><a href="eee2251videostd.php"><?php echo("EEE 2251 & EEE 2252") ;  ?></a>
...
<div class="page-container">
	...
	<br /><center><h2>Complex Variable,Differential Equations and Harmonic Analysis</h2></center>
      <?php 
  ...
  if(isset($_POST['new_comment'])) {
    ...
    if(isset($new_com_text)) {
      mysqli_query($con, "INSERT INTO parents1 ( user,text, date, code,course) VALUES ('$row[first_name]','$new_com_text', '$new_com_date', '$new_com_code','math2213')");
    }
  ...
  if(isset($_POST['new_reply'])) {
    ...
    if(isset($new_reply_text)) {
      mysqli_query($con, "INSERT INTO children1 (user, text, date, par_code,course) VALUES ('$row[first_name]','$new_reply_text', '$new_reply_date', '$new_reply_code','math2213')") or die(mysqli_error());
    }
