...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/components/datepicker.min.css" media="all" />
		...
		<center><h2>Login Here</h2></center>
			<form action="teacherlogin.php" method="post">
					...
					<div class="submit">
					  ...
					  <div class="rg"><center><a href="teacher.php">Registration Here</a></center></div>
			</form>
		</div>
...
<?php
	if(isset($_POST['login']))
	   {
		   $user_email=mysqli_real_escape_string($con,$_POST['user_email']);
			...
			$sel = "select * from teacher_info where email='$user_email' AND password='$user_pass'";
  ...
  echo '}, 100);</script>';
				...
				echo "<script>window.open('../teacher/5th/teacherhome.php','_self')</script>";
			}
	   }
?>
